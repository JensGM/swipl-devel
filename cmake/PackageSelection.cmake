...
set(SWIPL_PKG_DEPS_pldoc clib http sgml)
...
if(NOT MULTI_THREADED)
  ...
  swipl_del_package(redis     "requires multi-threading")
  swipl_del_package(pengines  "requires multi-threading")
  swipl_del_package(jpl       "requires multi-threading")
endif()
...
if(SWIPL_PACKAGES_GUI)
  if(CMAKE_SIZEOF_VOID_P LESS 8)
    swipl_del_package(xpce    "Requires a 64-bit architecture")
  else()
